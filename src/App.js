...
function UserCard(props) {
	...
	let emailInfo = <li style={cStyle}>{"Emial: " + props.user.email}</li>;
	let gender = <li style={cStyle}>{"Gender: " + props.user.gender}</li>;
	let age = (
	<li style={cStyle}>{"Age: " + props.user.dob.age + " years old"}</li>
	);
	let phone = <li style={cStyle}>{props.user.phone}</li>;
	let location = (
	<li style={cStyle}>
	{"From: " + props.user.location.street + ", " + props.user.location.city}
	</li>
	);
